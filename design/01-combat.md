...
Draft 1, 2026-09-13. Everything named here is built and playable unless marked otherwise.

## The pitch

**XCOM's tactics, without the turns.**

What makes an XCOM fight interesting is space: where the cover is, who can see whom, whether a shot is worth taking now or after moving. None of that needs turns.

So the fight runs in real time, pausable, at three speeds. The player reads the ground, places people and decides which shots are worth their cost. The cost is high because people are fragile and shots are slow.

## What is kept from XCOM

**Cover is the first thing you look at.** The game traces from the shooter's muzzle to each of the target's limbs and asks what is between them. Cover is a continuous number per limb, not a half/full flag.
...
**Shots are expensive.** Slow weapons, real reloads, scarce ammunition. A fight is a sequence of deliberate shots, not sustained fire. The frontier's standard long arm is a hand-charged pneumatic rifle for that reason.

**Flanking and sight lines are real geometry.** There is no hit-chance table. If the wall is between you, the wall is between you.
...
**Death as the default outcome.** See below.

**A health bar.** No single number represents a person's condition.
...
**Down is not dead.** A downed character lies where they fell, bleeding, and dies if nobody comes. Someone has to walk over, under fire, and treat them. The most common outcome of a fight is a person on the ground who can still be saved.
...
A hit does three things.

**Force.** Enough impact against a character's stability staggers or topples them. A grenade throws bodies.

**Suppression.** Near misses and hits build a meter. Suppressed characters stop advancing and look for cover. Pinned characters stop firing altogether. You can shoot at a position rather than a person.

## What surrounds the fight

The fight happens in the middle of everything else.
...
A squad behaves sensibly without micromanagement, and micromanagement pays when you want it.
