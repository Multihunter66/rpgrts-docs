...
Draft 1, 2026-09-04. Hangs off `04-tone-sheet.md`. The standing decision is a **realistic** target; art waits behind function, so this file exists to make every generated placeholder point the same way rather than to start an art pass.
...
- **Settler**: long coat or waxed jacket, wide hat or leather cap, goggles up on the brow, **a gas mask or dust mask hung at the chest or worn in the wind** (Metro, 2026-09-04: the desert's sand, salt and dust storms are the honest reason; cracked filters, scratched lenses, tape), gloves, high boots. A rifle longer than they are tall, carried slung. A pack, a canteen, a bedroll. Reads as *practical* from any distance.
...
Long, heavy, slow. Every one shows how it works:

- **Pneumatic rifle**: a reservoir tank under a long barrel, a **hand pump** along the tank (the Tikhar's pump handle, worked between shots), a charging valve, a brass gauge, walnut stock, iron furniture. The tank and the pump are the identity.
- **Laser musket**: a musket-length housing with the Builder cell visible in a brass cradle, a hand crank or a flywheel on the side, thick cabling, a lens, heat scoring. Assembled by a craftsman around one impossible object.
...
Hard sun, long shadows, dust and heat haze on the coast and foothills; the land is hostile by default (2026-09-04) and a green field reads as an achievement. Thin, clear, cold light in the highlands. Dead zones are hard low sun on warm sand, overexposed and slightly desaturated (Ueda's light), long shadows, still, with the one saturated point being whatever is running. Night is dark; lamps and fires are the only warmth, and a lit window means a town.
...
- **19th-century air rifles (Girandoni), lever-action rifles, hand-cranked dynamos**: the actual mechanisms.

## Asset brief template

Every prompt handed to an image generator or a 3D generator is written from this template. Fill every line; the generator gets the *Prompt* line, the rest is for the record.
...
Wear:         <how old, how repaired, by whom>
Scale:        <real-world dimensions; longest axis in cm>
Attach:       <for armour/weapons: the bone or socket it rides>
Avoid:        <what would make it wrong: smooth, new, fantasy, glowing, ornate...>
Prompt:       <the generator prompt, one paragraph, realistic, neutral background,
               three-quarter view, single object, no text>
```
